...
% h=plot(rho,delta,'.');
% hold on
% plot(rho(ic),delta(ic),'o','MarkerEdgeColor','r',...
%                            'MarkerFaceColor','r',...
%                            'MarkerSize',10)
% xlabel('rho'), ylabel('delta')
% fi_na=['../imgs/fig_int_int/fig_cluster_int_01_rho_deltra']
...
% view(view_mm)
% axis tight
% fi_na=['../imgs/fig_int_int/fig_cluster_int_02_en']
% fun_work_li_035_myfig_out(h,fi_na,3)
...
% view(view_mm)
% axis tight
% fi_na=['../imgs/fig_int_int/fig_cluster_int_03_cluster']
% fun_work_li_035_myfig_out(h,fi_na,3)
% 
% subplot(2,2,4)
ind_halo=(halo==0);
...
fi_na=['../imgs/fig_int_int/fig_cluster_int_04_halo'];
fun_work_li_035_myfig_out(h,fi_na,3)
